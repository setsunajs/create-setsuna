import { postcssConfig } from "./template/src/postcssConfig.js"
import { tailwindConfig } from "./template/src/tailwindConfig.js"
...
export function withCssOptions(type, pkg, template) {
  ...
  if (type === "tailwind") {
    ...
    src.set(postcssConfig[0], postcssConfig[1])
    src.set(tailwindConfig[0], tailwindConfig[1])
